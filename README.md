...
- **Dropdown:** every account, most headroom first, with 5-hour / weekly / Fable bars, a countdown and time for each reset, a thin timeline of how far along each window is, and Codex credit status. Refreshes every 5 minutes.
